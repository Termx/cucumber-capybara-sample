Feature: Create Account
    ...
    Scenario: Able to see an error message when the DOB is not provided or invalid
        ...
        And  I enter the account details with an invalid DOB
    ...
    Scenario: Able to see an error message when the phone number is not provided or invalid
        ...
        And  I enter the account details with an invalid phone number format
    ...
    Scenario: Able to see the password bar graph when the password is weak, moderate, strong, very strong and excellent
        ...
        And  I should see at least one number requirement has passed
        Then I should see the weak password bar graph of "width: 20%;"
        And  I enter the account details with a moderate password
        Then I should see the moderate password bar graph of "width: 40%;"
        And  I enter the account details with a strong password
        And  I should see at least one special symbol requirement has passed
        Then I should see the strong password bar graph of "width: 60%;"
        And  I enter the account details with a very strong password
        And  I should see both uppercase and lowercase letters requirement have passed
        Then I should see the very strong password bar graph of "width: 80%;"
        And  I enter the account details with an excellent password
        And  I should see at least 8 characters long requirement have passed
